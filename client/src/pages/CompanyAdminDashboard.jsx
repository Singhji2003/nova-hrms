...
export default function CompanyAdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* Hero Header */}
      <div className="p-8 rounded-3xl glass-card bg-gradient-to-r from-amber-950/60 via-slate-900/90 to-indigo-950/70 border border-slate-800/80 shadow-2xl relative overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div>
            ...
            <p className="text-sm text-slate-300 mt-1 max-w-xl leading-relaxed">
              Real-time executive metrics, attendance charts, payroll distribution, and hierarchical organization tree.
            </p>
          </div>

          <div className="flex items-center gap-3">
            <div className="p-4 rounded-2xl glass-panel text-center min-w-[120px] border border-amber-500/20">
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">HR Managers</p>
              <p className="text-2xl font-black text-amber-400 mt-0.5">{hrsCount}</p>
            </div>
            <div className="p-4 rounded-2xl glass-panel text-center min-w-[120px] border border-indigo-500/20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="p-6 rounded-3xl glass-card glass-card-hover border border-slate-800">
          ...
          <p className="text-xs text-amber-300 font-bold mt-2">Active HR Governance</p>
        </motion.div>
          ...
          <div className="p-5 rounded-2xl glass-panel space-y-4">
            ...
            <div className="space-y-2 pt-1">
              <div className="flex justify-between text-xs font-bold">
                ...
                <span className="text-amber-400">15% ($18,750)</span>
              </div>
              <div className="w-full h-3.5 bg-slate-900 rounded-full overflow-hidden border border-slate-800">
      ...
      <div className="p-8 rounded-3xl glass-card border border-violet-500/30 text-center space-y-8">
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          ...
          <span className="text-xs font-bold text-violet-300 px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/20">
        ...
        <div className="inline-block p-4 rounded-2xl glass-panel border border-amber-500/40 bg-amber-950/20 shadow-lg">
          <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" className="w-14 h-14 rounded-2xl object-cover mx-auto mb-2 ring-2 ring-amber-500 shadow-md" />
